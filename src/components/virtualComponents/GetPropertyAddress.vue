<template>
  <div>
    ...
    <form @submit.prevent="submitAddress" class="font-['DM_Sans']">
      <FormKit
        type="text"
...
const emit = defineEmits(["propertyAddressSubmitted"]);
